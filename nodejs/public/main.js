...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [_services_auth_service__WEBPACK_IMPORTED_MODULE_8__["AuthService"], _guards_auth_guard__WEBPACK_IMPORTED_MODULE_9__["AuthGuard"]],
...
module.exports = "<div class=\"pt-md-5 text-center\">\n  <p class=\"display-3\">MEAN Stack Project</p>\n  <p class=\"display-4\">by HenriqueYang</p>\n</div>"
...
module.exports = "<form [formGroup]=\"form\" (ngSubmit)=\"onSubmit()\">\n\n  <div class=\"row\">\n    <div class=\"col-sm-8\">\n      <label for=\"username\">Usuário</label>\n      <input type=\"text\" class=\"form-control\" formControlName=\"username\" id=\"username\" placeholder=\"Informe seu usuário\">\n    </div>\n  </div>\n\n  <div class=\"row\">\n    <div class=\"col-sm-8\">\n      <label for=\"password\">Senha</label>\n      <input type=\"password\" class=\"form-control\" formControlName=\"password\" id=\"password\" placeholder=\"Informe sua senha\">\n    </div>\n  </div>\n\n  <button type=\"submit\" class=\"btn btn-dark\">Conectar</button>\n\n</form>"
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(formBuilder, flashMessagesService, authService, router) {
    ...
    LoginComponent.prototype.onSubmit = function () {
        ...
        if (this.form.valid) {
            ...
            this.authService.athenticateUser(user_1).subscribe(function (data) {
                if (!data.success) {
                ...
                if (data.success) {
                    ...
                    _this.flashMessagesService.show("Bem vindo(a) " + user_1.username, {
...
module.exports = "<nav class=\"navbar navbar-dark bg-dark\">\n\n  <a class=\"navbar-item\" [routerLink]=\"['']\">\n    <img src=\"../../../assets/mean-logo.png\" width=\"120\" height=\"60\" alt=\"MEAN\">\n  </a>\n\n  <ul class=\"nav justify-content-end\">\n    <li class=\"nav-item\" *ngIf=\"!authService.loggedIn()\">\n      <a class=\"nav-link \" [routerLink]=\"['/register']\">Cadastrar</a>\n    </li>\n    <li class=\"nav-item\" *ngIf=\"!authService.loggedIn()\">\n      <a class=\"nav-link\" [routerLink]=\"['/login']\">Conectar</a>\n    </li>\n    <li class=\"nav-item\" *ngIf=\"authService.loggedIn()\">\n      <a class=\"nav-link\" [routerLink]=\"['/profile']\">Perfil</a>\n    </li>\n    <li class=\"nav-item\" *ngIf=\"authService.loggedIn()\">\n      <a class=\"nav-link\" (click)=\"onLogoutClick()\" [routerLink]=\"['/home']\">Desconectar</a>\n    </li>\n  </ul>\n</nav>"
...
module.exports = "<form [formGroup]=\"form\" (ngSubmit)=\"onSubmit()\">\n\n  <div class=\"row\">\n    <div class=\"col-sm-5\">\n      <label for=\"name\">Nome Completo</label>\n      <input type=\"text\" class=\"form-control\" formControlName=\"name\" id=\"name\" placeholder=\"Informe seu nome completo\">\n    </div>\n\n    <div class=\"col-sm-3\">\n      <label for=\"username\">Usuário</label>\n      <input type=\"text\" class=\"form-control\" formControlName=\"username\" id=\"username\" placeholder=\"Informe seu usuário\">\n    </div>\n\n  </div>\n\n  <div class=\"row\">\n    <div class=\"col-sm-8\">\n      <label for=\"email\">Email</label>\n      <input type=\"email\" class=\"form-control\" formControlName=\"email\" id=\"email\" placeholder=\"exemplo@email.com\">\n    </div>\n  </div>\n\n  <div class=\"row\">\n    <div class=\"col-sm-8\">\n      <label for=\"password\">Senha</label>\n      <input type=\"password\" class=\"form-control\" formControlName=\"password\" id=\"password\" placeholder=\"Informe sua senha\">\n    </div>\n  </div>\n\n  <button type=\"submit\" class=\"btn btn-dark\">Cadastrar-se</button>\n  \n</form>"
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent.prototype.ngOnInit = function () {
        this.form = this.formBuilder.group({
            name: [null, [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].minLength(3), _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].maxLength(20)]],
            username: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required],
    ...
    RegisterComponent.prototype.onSubmit = function () {
        ...
        if (this.form.valid) {
            ...
            this.authService.registerUser(user).subscribe(function (data) {
                if (!data.success) {
                    _this.flashMessagesService.show(data.msg, { cssClass: 'alert-danger', timeout: 1000 });
                }
                else {
                    _this.flashMessagesService.show(data.msg, { cssClass: 'alert-success', timeout: 1000 });
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.athenticateUser = function (user) {
        var headers = new _angular_http__WEBPACK_IMPORTED_MODULE_1__["Headers"]();
        headers.append('Content-Type', 'application/json');
...
module.exports = __webpack_require__(/*! C:\Users\CCC\Documents\MEAN Projects\meanProject\angular-app\src\main.ts */"./src/main.ts");
